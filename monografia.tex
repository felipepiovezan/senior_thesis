...
Pode-se também criar uma curva elíptica sobre $GF(2^m)$, cuja definição é dada a seguir, embora os demais conceitos desse capítulo sejam tratados apenas para o caso de $GF(p)$ para evitar demasiadas repetições. É importante lembrar, porén, que a escolha do grupo tem implicações tanto em como seus elementos são representados em memória como na definição de algumas operações e algoritmos. 
