...
\begin{enumerate}
	...
	\item Cada uma das partes escolhe um número inteiro aleatório $s$ no intervalo $[1, r-1]$ e computa o ponto $W = sG$. $s$ e $W$ são chamados de chave pública e privada, respectivamente.
	\item Obter da outra parte a chave pública dela, $W'$.
	\item Cara parte pode computar $P = sW' = (x_P, y_P)$. $x_P$ será considerado o segredo compartilhado.
